...
<div class="rhs_actions2">	
	<h3><?php echo __('Actions'); ?></h3><br/>
	<?php echo $this->Html->link(__('Edit Blog Post'), array('action' => 'edit', $blogPost['BlogPost']['id'])); ?>
	<?php echo $this->Form->postLink(__('Delete Blog Post'), array('action' => 'delete', $blogPost['BlogPost']['id']), null, __('Are you sure you want to delete # %s?', $blogPost['BlogPost']['id'])); ?> 
	<?php echo $this->Html->link(__('List Blog Posts'), array('action' => 'index')); ?>
	<?php echo $this->Html->link(__('New Blog Post'), array('action' => 'add')); ?>
